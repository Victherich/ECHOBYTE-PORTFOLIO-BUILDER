...
// // 1. Initialize state from localStorage (defaults to false if nothing is saved)
// const [paymentSession, setPaymentSession] = useState(() => {
//   const savedSession = localStorage.getItem("paymentSession");
//   return savedSession ? JSON.parse(savedSession) : false;
// });

// // 2. Automatically save state changes to localStorage
// useEffect(() => {
...
//           //correct these futher actions in the success block
//     clearInterval(intervalId);
